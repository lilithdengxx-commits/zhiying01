...
const leads = [
  ...
  {
    id: 'RENEWAL-003',
    title: '天津滨海新区城管委二期智能化改造+维保续签',
    type: 'renewal', typeName: '二次商机', typeColor: 'purple',
    signalSource: '企业新闻',
    score: 82,
    scoreReason: '维保合同6月到期，续签+升级捆绑谈判机会，许主任对现有系统评价良好',
    summary: '滨海新区数字城管平台（380万，2023年交付）维保合同将于2026年6月到期。许明刚主任在最近几次回访中表达了升级意向：现有平台AI能力不足，希望在续签同时升级城管AI大脑和视频智能分析模块。',
    source: '客户管理系统（CRM）',
    sourceUrl: '',
    region: '天津市',
    city: '天津市',
    ...
    createdAt: '2026-03-19',
    updatedAt: '2026-03-19',
    nextAction: '4月初安排许主任拜访，明确维保续签+升级捆绑方案，争取Q2完成合同签署',
    budget: 650,
    department: '天津市滨海新区城市管理委员会',
    contact: '许明刚',
    contactRole: '城管委主任',
    tags: ['维保续签', '二次商机', '智慧城管', '华北区'],
    deadline: '2026-06-01',
    isRealtime: false,
  },
  {
    id: 'RENEWAL-004',
    title: '贵州省大数据局二期——省级AI决策支持平台（3500万）',
    type: 'renewal', typeName: '二次商机', typeColor: 'purple',
    signalSource: '企业新闻',
    score: 94,
    scoreReason: '省级项目，历史合作深度强，吴副局长是我方强关键人，贵州数博会前立项概率极高',
    summary: '贵州省大数据认知计算平台（3200万，2023年技术总包）已成为省级标杆案例，吴光明副局长多次在行业大会推介我司产品。2026年贵州数博会（5月15日）将是关键时间节点，省局计划借助数博会发布二期项目采购公告，聚焦AI决策支持和跨省数据要素协同。',
    source: '客户管理系统（CRM）',
    sourceUrl: '',
    region: '贵州省',
    city: '贵阳市',
    ...
    nextAction: '5月数博会前完成立项申请材料和技术方案，确认是否参加数博会联合发布',
    budget: 3500,
    department: '贵州省大数据发展管理局',
    contact: '吴光明',
    contactRole: '副局长',
    tags: ['老客续签', '二次商机', 'AI决策', '省级项目', '超大单'],
    deadline: '2026-05-10',
    isRealtime: false,
  },
  {
    id: 'RENEWAL-005',
    title: '北京海淀区政务服务局三期——AI大模型+智能审批接入',
    type: 'renewal', typeName: '二次商机', typeColor: 'purple',
    signalSource: '企业新闻',
    score: 85,
    scoreReason: '北京市统一AI集采背景下，海淀区先行先试意愿强烈，马局长是重要支持者',
    summary: '海淀区一体化政务服务平台（1100万总包，2023年）运维期效果良好，年度满意度评分4.8/5。马建设局长主动联系，希望在北京市统一AI能力集采前，先行在海淀区开展DIOS大模型智能审批试点，预算约1800万，计划Q3进入采购程序。',
    source: '客户管理系统（CRM）',
    sourceUrl: '',
    region: '北京市',
    city: '北京市',
    ...
    nextAction: '3月底前提交《海淀区AI智能审批试点方案》，争取纳入区政府重点项目清单',
    budget: 1800,
    department: '北京市海淀区政务服务局',
    contact: '马建设',
    contactRole: '局长',
    tags: ['老客续签', '二次商机', 'AI大模型', '智能审批', '华北区'],
    deadline: '2026-04-15',
    isRealtime: false,
  },
]
...
const customers = [
  ...
  },
  {
    ...
    renewal: { risk: 'low', riskName: '低风险', title: '二期智能化改造：城管AI大脑升级+维保续签', value: 650, date: '2026-Q2' },
    contacts: [
  ...
  },
  {
    ...
    renewal: { risk: 'low', riskName: '低风险', title: '西南区战略扩张：成都市级数据治理平台推广商机', value: 2200, date: '2026-Q4' },
    contacts: [
  ...
  },
  {
    ...
    renewal: { risk: 'low', riskName: '低风险', title: '三期AI大模型+智能审批接入（北京市统一集采候选）', value: 1800, date: '2026-Q3' },
    contacts: [
  ...
  },
  {
    ...
    renewal: { risk: 'low', riskName: '低风险', title: '二期：省级AI决策支持平台建设（贵州数博会重点项目）', value: 3500, date: '2026-Q3' },
    contacts: [
